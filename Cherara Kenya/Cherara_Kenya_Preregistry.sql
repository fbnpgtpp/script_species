...
with cte as(
	...
	coalesce(tr.translationlabel, sp.nom_latin) as labelkj,
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
...
where ps.projectid = 99
	...
	concat(coalesce(tr.translationlabel, sp.nom_latin) , ' jumlah pohon') as labelkj, --CHANGE OR DELETE TRANSLATION
	'' as hinten,
	'' as hintin,
	'TRUE' as required,
	'' as apearence,
...
where ps.projectid = 99
	...
	replace(concat('<span style="color:#099665">', coalesce(tr.translationlabel, sp.nom_latin) , ' bagian :</span> %DOL{',species_code,'_share} %'),'%DOL','$') as labelkj, --CHANGE OR DELETE TRANSLATION
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
...
where ps.projectid = 99
	...
	concat(coalesce(tr.translationlabel, sp.nom_latin) , ' Jumlah total pohon : <span style="color:red">${',species_code,'_total_nb} pohon</span>') as labelkj, --CHANGE OR DELETE TRANSLATION
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
