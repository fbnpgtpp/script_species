...
left join schemav5.translations tr on tr.id = sp.translationid and tr.languagecode = 'in'
...
where ps.projectid = 99
	...
	concat(coalesce(tr.translationlabel, sp.latinname) , ' - <span style="color:red">Living</span> trees at monitoring 1 :') as labelin, --CHANGE OR DELETE TRANSLATION
	'' as hinten,
	'' as hintin,
	'TRUE' as required,
	'' as apearence,
...
with cte as(
	...
	replace(concat(coalesce(tren.translationlabel, sp.latinname),' - Total number of delivered trees : %DOL{',species_code,'_nb_delivered_trees} trees'),'%DOL','$') as labelen,
	replace(concat(coalesce(tr.translationlabel, sp.latinname),' - Total number of delivered trees : %DOL{',species_code,'_nb_delivered_trees} trees'),'%DOL','$') as labelin, --CHANGE OR DELETE TRANSLATION
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
...
where ps.projectid = 99
	...
	replace(concat(coalesce(tren.translationlabel, sp.latinname),' - Total number of living trees : %DOL{recap_',species_code,'_total_nb_living} trees'),'%DOL','$') as labelen,
	replace(concat(coalesce(tr.translationlabel, sp.latinname),' - Total number of living trees : %DOL{recap_',species_code,'_total_nb_living} trees'),'%DOL','$')as labelin, --CHANGE OR DELETE TRANSLATION
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
...
where ps.projectid = 99
	...
	replace(concat(coalesce(tren.translationlabel, sp.latinname),' - Loss rate : %DOL{recap_loss_rate_delivered_monitoring1_',species_code,'} %'),'%DOL','$') as labelen,
	replace(concat(coalesce(tr.translationlabel, sp.latinname),' - Loss rate : %DOL{recap_loss_rate_delivered_monitoring1_',species_code,'} %'),'%DOL','$') as labelin, --CHANGE OR DELETE TRANSLATION
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
...
where ps.projectid = 99
	...
	concat('Comments about ',coalesce(tr.translationlabel, sp.latinname)) as labelin, --CHANGE OR DELETE TRANSLATION
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
