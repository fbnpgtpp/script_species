...
where ps.projectid = 99
	...
	replace(concat(coalesce(tren.translationlabel, sp.latinname),' - Total number of living trees : %DOL{recap_',species_code,'_total_nb_living_note} trees'),'%DOL','$') as labelen,
	replace(concat(coalesce(tr.translationlabel, sp.latinname),' - Total number of living trees : %DOL{recap_',species_code,'_total_nb_living_note} trees'),'%DOL','$')as labelin, --CHANGE OR DELETE TRANSLATION
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
