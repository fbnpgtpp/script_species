...
where ps.projectid = 98
	...
	concat(coalesce(tr.translationlabel, sp.nom_latin) , ' jumlah pohon') as labelin,
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
...
where ps.projectid = 98
	...
	replace(concat('<span style="color:#099665">', coalesce(tr.translationlabel, sp.nom_latin) , ' bagian :</span> %DOL{',species_code,'_share} %'),'%DOL','$') as labelin,
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
...
where ps.projectid = 98
	...
	replace(concat(	'<span style="color:#E6361D">',coalesce(tr.translationlabel, sp.nom_latin),' jumlah pohon yang tersisa :</span> %DOL{trees_available_after_', species_code, '} pohon'), '%DOL','$') as labelin,
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
