...
with cte as(
	...
	replace(concat(coalesce(tr.translationlabel, sp.latinname),' - Total number of delivered trees : %DOL{',code,'_nb_delivered_trees} trees'),'%DOL','$') as labelin, --CHANGE OR DELETE TRANSLATION
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
...
where ps.projectid = 98
	...
	replace(concat(coalesce(tr.translationlabel, sp.latinname),' - Total number of living trees : %DOL{recap_',code,'_total_nb_living} trees'),'%DOL','$')as labelin, --CHANGE OR DELETE TRANSLATION
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
...
where ps.projectid = 98
	...
	replace(concat(coalesce(tr.translationlabel, sp.latinname),' - Loss rate : %DOL{recap_loss_rate_delivered_monitoring1_',code,'} %'),'%DOL','$') as labelin, --CHANGE OR DELETE TRANSLATION
	'' as hinten,
	'' as hintin,
	'' as required,
	'' as apearence,
